...
const banners = [
  {
    desktop: "/market-installment-desktop.webp",
    tablet: "/market-installment-tablet.webp",
    mobile: "/market-installment-mobile.webp",
    href: "/catalog",
    label: "Рассрочка 12 месяцев на все товары",
  },
  {
    desktop: "/market-gift-desktop.webp",
    tablet: "/market-gift-tablet.webp",
    mobile: "/market-gift-mobile.webp",
    href: "/catalog",
    label: "Купите холодильник — чайник в подарок",
  },
  {
    desktop: "/market-sale-desktop.webp",
    tablet: "/market-sale-tablet.webp",
    mobile: "/market-sale-mobile.webp",
    href: "/catalog",
    label: "Горячие скидки до 30 процентов",
  },
  {
    desktop: "/market-address-desktop.webp",
    tablet: "/market-address-tablet.webp",
    mobile: "/market-address-mobile.webp",
    href: "/contacts",
